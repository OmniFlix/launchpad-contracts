...
mod tests {
    ...
    fn test_proper_init() {
        ...
        assert_eq!(config.mint_price.denom, "uflix".to_string());
        assert_eq!(config.start_time, Timestamp::from_nanos(1000000000));
        assert_eq!(config.mint_price.amount, Uint128::from(1000000u128));
    ...
    pub fn test_mint() {
        let mut env = mock_env();
        env.block.time = Timestamp::from_nanos(1_000);
        ...
        assert_eq!(
            ...
            MsgMintOnft {
                ...
                royalty_share: "100000000000000000".to_string(),
                sender: env.clone().contract.address.to_string(),
                extensible: true,
                nsfw: false,
                transferable: true,
        ...
        assert_eq!(mintable_tokens.iter().any(|x| x.token_id == "309"), false);
