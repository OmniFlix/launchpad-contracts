...
import { Uint128, InstantiateMsg, Coin, ExecuteMsg, Addr, Timestamp, Uint64, Round, QueryMsg, ParamsResponse, Params } from "./OmniflixWhitelistFactory.types";
export interface OmniflixWhitelistFactoryReadOnlyInterface {
  contractAddress: string;
  params: () => Promise<ParamsResponse>;
}
export class OmniflixWhitelistFactoryQueryClient implements OmniflixWhitelistFactoryReadOnlyInterface {
...
export interface OmniflixWhitelistFactoryInterface extends OmniflixWhitelistFactoryReadOnlyInterface {
  contractAddress: string;
  sender: string;
  createWhitelist: ({
    msg
...
export class OmniflixWhitelistFactoryClient extends OmniflixWhitelistFactoryQueryClient implements OmniflixWhitelistFactoryInterface {
