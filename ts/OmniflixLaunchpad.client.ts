...
import { Uint128, Timestamp, Uint64, InstantiateMsg, CollectionDetails, ExecuteMsg, QueryMsg, Addr, Decimal, Config, Coin, ArrayOfToken, Token, UserDetails, Uint32 } from "./OmniflixLaunchpad.types";
export interface OmniflixLaunchpadReadOnlyInterface {
...
export class OmniflixLaunchpadQueryClient implements OmniflixLaunchpadReadOnlyInterface {
...
export interface OmniflixLaunchpadInterface extends OmniflixLaunchpadReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class OmniflixLaunchpadClient extends OmniflixLaunchpadQueryClient implements OmniflixLaunchpadInterface {
